          ...
          <div style={styles.signupFormFields}>
            <div style={styles.signupFormGroup}>
              ...
              <input
                ...
                onBlur={() => setUserCodeTouched(true)}
                required
              />
            </div>
            {userCodeTouched && isCheckingUserCode && <div style={styles.errorText}>Đang kiểm tra...</div>}
            {userCodeTouched && userCodeError && !isCheckingUserCode && <div style={styles.errorText}>{userCodeError}</div>}
            ...
            {(passwordTouched || confirmPasswordTouched) && passwordError && <div style={styles.errorText}>{passwordError}</div>}
...
{nameTouched && nameError && <div style={styles.errorText}>{nameError}</div>}
...
{emailTouched && isCheckingEmail && <div style={styles.errorText}>Đang kiểm tra...</div>}
{emailTouched && emailError && !isCheckingEmail && <div style={styles.errorText}>{emailError}</div>}
...
{phoneTouched && isCheckingPhone && <div style={styles.errorText}>Đang kiểm tra...</div>}
{phoneTouched && phoneError && !isCheckingPhone && <div style={styles.errorText}>{phoneError}</div>}
